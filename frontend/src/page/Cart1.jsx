    ...
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="w-full  my-10">
        <div className=" rounded-[15px]  mx-auto  xl:flex max-w-[1320px] justify-between gap-[55px]">
          <div className="max-lg:py-[25px] max-lg:px-[25px] py-[50px]  px-[45px] bg-white w-full  ">
            ...
            {cartItems.map((item) => (
              <div className="w-full flex items-center  max-h-[100px] rounded-[15px] shadow mt-[29px]">
                <div
                  key={item.id}
                  className="w-full flex md:flex-1 items-center px-[10px] py-[9px] pl-[9px] max-lg:pr-0 pr-[23px] "
                >
                  <img
                    src={item.img}
                  ...
                  <div className="pl-[16px] lg:px-[18px]">
                    <h3 className=" text-[rgba(30,30,30,1)] font-medium max-lg:text-[16px] text-[18px] leading-[100%]">
                      {item.name}
                    </h3>
                    <p className=" mt-[3px] font-medium text-[14px] max-lg:text-[12px] leading-[100%] flex-nowrap">
                      {item.desc}
                    </p>
                    <div className=" items-center ml-auto max-md:flex hidden mt-1 gap-[6px]">
                      <span className="font-semibold max-lg:text-[18px] text-[22px] lining-nums proportional-nums ">
                        {item.qty}
                      </span>
                ...
                <div className="flex flex-1 justify-between items-center mr-[23px]">
                  <div className="max-md:hidden flex items-center ml-auto  gap-[6px]">
                  ...
                  <button className="max-md:w-[20px] max-md:h-[20px] w-[25px] h-[25px] max-lg:ml-[20px] ml-[38px] items-center flex cursor-pointer  ">
          ...
          <div className="max-xl:max-w-[90%] max-w-[388px] mx-auto rounded-[20px] h-auto bg-[rgba(86,90,187,1)] my-[50px]">
            <div className="flex flex-col  max-xl:py-[21px] py-0 lg:mt-[27px] mb-[21px] mx-[19px]">
              ...
              <div className="mt-[15px]">
                <span className="text-[rgba(254,252,252,1)] font-medium text-[16px] leading-[100%]">
                  Card type
                </span>
                <div className="w-full max-lg:flex-wrap flex-nowrap gap-[17px] flex flex-row mt-[14px] mx-auto justify-center ">
                  <div className="">
      ...
      <footer className="w-full border-t border-b border-[#e9eaec] bg-white">
        <div className="max-w-[1320px] w-full mx-auto max-xl:px-4 px-0">
          <Footer />
        </div>
        <section className="flex-1 border-t border-[#e9eaec] w-full mx-auto max-sm:px-4 px-0">
          <div className="max-w-[1320px] w-full mx-auto max-xl:px-4 px-0">
            <Copyright />
          </div>
        </section>
